...
class Projeto:
    ...
    def _add_tarefa(self, tarefa, **kwargs):  # private
    ...
    def procurar(self, descricao):
        ...
        except IndexError as e:  # usar Exception seria generico
...
class Tarefa:
    ...
    def __str__(self):
        ...
        elif self.vencimento:  # se tiver sido setada
...
def main():
    ...
    try:
        ...
        print(TerminalColor.ERRO +
              f'Error: "{str(e)}"!' + TerminalColor.NORMAL)
